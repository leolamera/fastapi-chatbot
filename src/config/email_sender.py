...
def send_text_email(mail_content: str, email_dict: MIMEMultipart): 
    email_dict.attach(MIMEText(mail_content, 'html'))
    return []
...
def create_html_template(type_of, name, email, whatsapp, motivo=None, obs=None):
                                ...
                                <tr>
                                    <td align="center" style="padding:0;Margin:0">
                                        <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                            ...
                                            <tr>
                                                <td align="left"
                                                    style="padding:0;Margin:0;padding-top:20px;padding-left:20px;padding-right:20px;background-position:center center">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-c"
                                                                            ...
                                                                            <h1
                                                                                style="Margin:0;line-height:48px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:40px;font-style:normal;font-weight:bold;color:#333333;text-align:left">
                                                                                Ticket: #{ticket_id}</h1>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-c"
                                                                            ...
                                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:27px;color:#999999;font-size:18px"
                                                                                class="p_description">Um novo ticket acabou de
                                                                                ser registrado pelo chatbot. Segue as
                                                                                informações sobre do usuário.</p>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-c"
                                                                            ...
                                                                            <h3
                                                                                ...
                                                                                <strong>Número do ticket</strong></h3>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-c"
                                                                            ...
                                                                            <h3
                                                                                style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333">
                                                                                <strong>Nome Completo</strong></h3>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-c"
                                                                            ...
                                                                            <h3
                                                                                style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333">
                                                                                <strong>Número Telefônico</strong></h3>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left"
    ...
    if (type_of == 'lead'):
        return template_style + template_lead_html

    if(type_of == 'attend'):
        return template_style + template_atendimento_html
